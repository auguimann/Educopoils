...
<div class="main">
    ...
    <svg class="sausage-dog-animation" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 1200 1080">
        <ellipse class="shadow" ry="45" rx="350" cy="816" cx="498" opacity="1" fill="#212529" fill-opacity="1" stroke="#212529" stroke-width="4" />
    ...
    <div>
        ...
        <p>Votre chien s'est perdu...</p>
        <a class="btn btn-dark" href="http://educopoils.fr" role="button">Retour à l'accueil</a>
